...
var author$project$Main$EducationItem = F5(
	function (school, degree, time, place, achievements) {
		return {achievements: achievements, degree: degree, place: place, school: school, time: time};
	});
						...
						[
							...
							_List_fromArray(
								[
									...
									A2(elm$html$Html$Attributes$style, 'color', '#833')
								]),
							_List_fromArray(
								[
									elm$html$Html$text(item.time)
								])),
							A2(
							elm$html$Html$h4,
							_List_fromArray(
								[
									A2(elm$html$Html$Attributes$style, 'flex', '4'),
...
var author$project$Main$experience = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('section-header'),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(
		{}))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.EducationItem":{"args":[],"type":"{ school : String.String, degree : String.String, time : String.String, place : String.String, achievements : List.List String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"SelectedEducationItem":["Main.EducationItem"],"Noop":[]}},"List.List":{"args":["a"],"tags":{}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));